...
public Vector3D cross(Vector3D A) //векторное произведение на вектор ј.
{
...
public float dot(Vector3D A) //скл€рное произведение с вектором ј.
{
    return (A.x * x + A.y * y + A.z * z);
}
public float mag() //вычисление модул€ вектора.
{
