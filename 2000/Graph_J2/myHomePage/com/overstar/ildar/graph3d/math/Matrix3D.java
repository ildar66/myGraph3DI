...
public class Matrix3D {
    ...
    public final static String axisX = "X";
    public final static String axisY = "Y";
    public final static String axisZ = "Z";
public Matrix3D() {
    identity();
}
//инициализация системы координат(СК).
...
//вращение СК на угол theta вокруг оси axist.
public void rotate(double theta, String axis, boolean isRad) {
    if (!isRad)
        theta *= toRad;
...
//изменение масштаба по оси x(a), y(b), z(c)
public void scale(float a, float b, float c) {
    e00 *= a;
    e11 *= b;
    e22 *= c;
}
//координаты точки3D в этой системе координат.
