...
/////////////////////////////////////////////////////Блок отмены методов "new ..." 
   ...
   void delete(Swarm e)   //удаление элемента "e"
	 ...
	 }   synchronized void rotate(Swarm theSide)     //new : вращение Element-a "e" 
	 {                                                           
	  matrix.identity();
	 ...
	 }   synchronized void rotate(Swarm elem, int a, int b, float rotate)  //new : вращение Element-a "e" вокруг оси(a,b)
	 {                                                                 //на угол=rotate
