 ...
 class Element extends Swarm {             //элемент стороны(Side) фигуры(Figure). 
  ...
  protected void add(int number)  {   //добавл€ет к полю(field) ссылку на трехмерную точку с номером(number).                           
