 ...
 import java.awt.*;
   ...
   static int  tab, x0, y0, kind, step, zero;             //tab-для навигации по элементам мира;kind-вид элемента;step-перемещение элемента по осям.(x0,y0)-тень последней записанная точка.
...
//	   if(swarm instanceof Side)  {     // учет 3Dточек элементов "elem" стороны "Side"
