 ...
 public class Piace_A extends Panel implements MouseListener, MouseMotionListener { 
  
   Anim3DI graph;                                 //апплет
...
/////////////////////////////////////////////////////Блок отмены методов "new ..." 
   synchronized void copy(Element e) //копирование элемента "е"
     {
