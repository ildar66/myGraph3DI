 ...
 class Figure extends Side {    //Фигура(Figure), состоящая из сторон(Side).
  ...
  public Figure(Piace_A piace, int kind, Color color, boolean full, boolean net, boolean flag_backface) 
   {
  ...
  public String toString()  {                //информация о углах анимации, оси вращения.
