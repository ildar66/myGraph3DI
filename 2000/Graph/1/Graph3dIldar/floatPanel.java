 ...
 public class floatPanel extends Frame implements ActionListener, ItemListener {
   ...
   public void update(Graphics g)                         //start new text:
     {
       ...
       paint(offScreen);
       g.drawImage(offScreenImage, 0, 0, this);            //end new metod;      
     }                                                  
  public void paint(Graphics g)
    ...
    //  g.fillPolygon(piace.select.getShade(zero, viewer));
      for (int i=0; i<piace.figure.sides.size(); i++)
       {
         Side side = (Side)piace.figure.sides.elementAt(i);
      ...
      if (evt.getSource() instanceof Button)
        {
         if (obj.equals(" Full "))
           ...
           { piace.net = true; net.setLabel("Net OFF");}
         else if (obj.equals("Net OFF")) 
           { piace.net = false; net.setLabel("Net ON");}
