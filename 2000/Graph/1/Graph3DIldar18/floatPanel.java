 ...
 public class floatPanel extends Frame implements ActionListener,
   ...
   floatPanel(Figure f, String title)               
    { 
      ...
      kind.addItemListener(this); view.addItemListener(this);      
      north_panel.add(kind); north_panel.add(net);
      net.addActionListener(this); backface.addActionListener(this);
      north_panel.add(view); north_panel.add(backface);
