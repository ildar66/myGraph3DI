 ...
 public class Shade {   ////////////////////////////////////отображение теней в режиме рисования.
  ...
  public static void mouseDown(Piace piace, int x, int y)  //начало создания тени элемента-select.
    { 
      if (piace.select.field.size() == 0)
        { x_anchor  = x; y_anchor  = y;}
    } 
  public static void mouseDrag(Piace piace, int x, int y)  //перемещение тени при рисовании.
    {
      drawbox(piace, x, y);
      x_anchor = x;
      y_anchor = y;
