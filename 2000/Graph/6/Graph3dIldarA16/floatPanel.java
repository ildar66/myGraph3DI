   ...
   public void setControl()
    {
      ...
      if (piace.select.full)
        full.setLabel("Empty"); //дописать контроль backface and net   
      else
        full.setLabel(" Full ");   
      if (piace.figure.net)
        net.setLabel("Net OFF"); //дописать контроль backface and net   
      else
        net.setLabel("Net ON");   
      if (piace.figure.flag_backface)
        backface.setLabel("Backface OFF"); //дописать контроль backface and net   
      else
