 ...
 /*  public void delete(Element e)
     {
      if(e instanceof Figure)
       ...
       { 
        copy = (Side)e; //позволяет создать режим вхождения в Element!!!
        do {
             int t = ((Integer)e.field.elementAt(0)).intValue();//заменить на deletelast3D()
...
/*   public void deletePoint3D(int t) //old metod
     {
       points3D.removeElementAt(t);
