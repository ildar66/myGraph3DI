   ...
   public void keyPressed(KeyEvent e) 
     {
       ...
       if ((key == e.VK_UP)&& e.isControlDown())
           translate(select, 0, -Math.abs(step), 0);//{scale(select, 1f, 1.1f, 1f);}
       if ((key == e.VK_DOWN)&& e.isControlDown())
           translate(select, 0, Math.abs(step), 0); //{scale(select, 1f, 1f/1.1f, 1f);}
       if ((key == e.VK_RIGHT)&& e.isControlDown())
           translate(select, Math.abs(step), 0, 0); //{scale(select, 1.1f, 1f, 1f);}
       if ((key == e.VK_LEFT)&& e.isControlDown())
           translate(select, -Math.abs(step), 0, 0);//{scale(select, 1f/1.1f, 1f, 1f);} 
       ...
       if ((key == e.VK_UP)&& e.isShiftDown())
           translate(figure, 0, -Math.abs(step), 0);//{scale(figure, 1f, 1.1f, 1f);}
       if ((key == e.VK_DOWN)&& e.isShiftDown())
           translate(figure, 0, Math.abs(step), 0); //{scale(figure, 1f, 1f/1.1f, 1f);}
       if ((key == e.VK_RIGHT)&& e.isShiftDown())
           translate(figure, Math.abs(step), 0, 0); //{scale(figure, 1.1f, 1f, 1f);}
       if ((key == e.VK_LEFT)&& e.isShiftDown())
           translate(figure, -Math.abs(step), 0, 0);//{scale(figure, 1f/1.1f, 1f, 1f);} 
