      ...
      for (int i=0, t=0; i<field.size(); i++) 
        {
          ...
          if ((view.equals("view Face"))||(view.equals("shade")))    
            poly.addPoint(offset.x + (int)current.x, offset.y + (int)current.y); 
          else if (view.equals("view Right"))    
            poly.addPoint(offset.x + (int)current.z, offset.y + (int)current.y); 
          else if (view.equals("view Up"))    
            poly.addPoint(offset.x + (int)current.x, offset.y - (int)current.z);       
        }
