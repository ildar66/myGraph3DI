 ...
 /////////////////////////////////////////////////////////////////////////////////Северная панель
   class NorthPanel extends Panel implements ActionListener, ItemListener{
     ...
     public NorthPanel(Piace piace)    {
       ...
       CheckboxGroup group = new CheckboxGroup();
       add(side = new Checkbox("Side", group, false)); side.addItemListener(this); side.setEnabled(false);          
       add(figure = new Checkbox("Figure", group, true)); figure.addItemListener(this); figure.setEnabled(false);           
       add(all = new Checkbox("All", group, false)); all.addItemListener(this); all.setEnabled(false);           
     }
