...
///////////////////////////////////////////////////////////////////////////////Южная панель
 ...
 /////////////////////////////////////////////////////////////////////////////////Северная панель
   class NorthPanel extends Panel implements ActionListener{
     Piace piace; 
     Button regime = new Button("regime Move");
     public NorthPanel(Piace piace)    {
       ...
       makeButton("FP");
       add(regime); regime.addActionListener(this); regime.setBackground(Color.green);          
     }
     ...
     public void actionPerformed(ActionEvent ev)  {
       ...
       else if (obj.equals("regime Move"))   //переключение режима.
         {piace.regimeMove = true; regime.setLabel("regime Paint"); regime.setBackground(Color.yellow);}
       else if (obj.equals("regime Paint")) //переключение режима.
         {piace.regimeMove = false; regime.setLabel("regime Move"); regime.setBackground(Color.green);}
 ...
 class EastPanel extends Panel implements ActionListener{
     ...
     public void actionPerformed(ActionEvent ev) {
       ...
       if ((obj.equals("Ctrl+Del")) && (piace.points3D.size() != 0))         
         {piace.delete(piace.select); piace.graph.SP.setControl();}                         
       if ((obj.equals("Shift+Del")) && (piace.points3D.size() != 0))         
