       ...
       if(e instanceof Figure)
        {
         while(e.elements.size() != 0)
           delete((Side)e.elements.lastElement());  //удаление подЭлементов элемента "e"
        } 
       if(e instanceof Side) 
        {
         copy = (Side)e;    //сохранение "e" в "copy"
         while(e.elements.size() != 0)
           delete((Element)e.elements.lastElement());  //удаление подЭлементов элемента "e"
