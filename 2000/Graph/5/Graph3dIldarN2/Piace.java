 ...
 public class Piace extends Panel implements MouseListener, MouseMotionListener, KeyListener { 
   ...
   int  tab, x0, y0, kind, step;                   //tab-для навигации по элементам мира;kind-вид элемента;step-перемещение элемента по осям.(x0,y0)-тень последней записанная точка.
   ...
   Rectangle rect = new Rectangle(0, 0, 10, 10);   //следует за нажатием мыши и определяет частоту записи 3Dточек.
   ...
   public void mousePressed(MouseEvent e) 
    {
      ...
      rect.translate(x - rect.x - 5, y - rect.y - 5);  //"rect" следует за нажатием мыши
   ...
   public void SavePoint3D(int i, int x, int y)        //запись новой точки Элемента,"i"-номер точки
    {
      select.add(i);
   ...
   public int numberPoint(int x, int y) //возвращает номер точки с координатами(x,y)
    {                                   
...
///////////////////////////////////////////////////////Блок вращения элементов:
   public void rotate(String axis, Element e)            //вращение Element-a "e" вокруг оси "axis"
     {                                                   //на угол "rotate"
       matrix.identity();
...
///////////////////////////////////////////////////////Блок перемещения элементов:
   public void translate(Element e, int dx, int dy, int dz)  //перемещение "e" на расстояние "dx", "dy", "dz"
     {
       matrix.identity();
...
///////////////////////////////////////////////////////Блок масштабирования элементов:
   public void scale( Element e, float x, float y, float z) //масштабирование "е" по осям X, Y, Z
     {
       matrix.identity();
       matrix.scale(x, y, z);
       transform(matrix, e.field);
...
///////////////////////////////////////////////////////Блок для рисования элементов:
   ...
   public void net(Graphics g, Vector vector)  //сетка для "vector"-a
    { 
   ...
   public void sort(Vector v)                  //сортировка "vector"-a по удаленности его элементов 
     {
       int j = v.size();
       while(--j > 0)
        { 
