 ...
 public class Move {   //движение элементов с помощью мыши.
  ...
  static void mouseDown(Piace_A piace, int x, int y)
    { 
  ...
  static void mouseDrag(Piace_A piace, int x, int y)
    {
  ...
  static void mouseUp(Piace_A piace)
    {
      piace.repaint(); 
      typeTranslate = false;
 ...
 static void mouseClicked(Piace_A piace, int x, int y) {
