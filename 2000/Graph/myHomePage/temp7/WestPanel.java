 ...
 import javax.swing.*;
   ////////////////////////////////////////////////////////////////////////////////////Панель Динамики.
   class WestPanel extends JPanel implements ActionListener{
	 Piace piace;
	 ...
	 public WestPanel(Piace piace) 
	 {
	   ...
	   makeLabel("Rotate:", gridbag, c, Color.blue, SwingConstants.CENTER);
		  c.gridwidth = 1;
	   ...
	   makeLabel("Direct:", gridbag, c, Color.blue, SwingConstants.CENTER);
		  c.gridwidth = 1;
	   ...
	   makeLabel("Transfer:", gridbag, c, Color.blue, SwingConstants.CENTER);
	   makeLabel("  Piace", gridbag, c, Color.yellow, SwingConstants.LEFT);
		  c.gridwidth = GridBagConstraints.RELATIVE; 
	   ...
	   makeButton("Down", gridbag, c);
  	  c.gridwidth = GridBagConstraints.REMAINDER;
	   makeButton("<-", gridbag, c);   
	   makeLabel("Figure Shift", gridbag, c, Color.yellow, SwingConstants.LEFT);
		  c.gridwidth = GridBagConstraints.RELATIVE; 
	   makeButton(" Up", gridbag, c);
		  c.gridwidth = GridBagConstraints.REMAINDER; 
	   makeButton(" ->", gridbag, c);
	   ...
	   makeLabel("Select Ctrl", gridbag, c, Color.yellow, SwingConstants.LEFT);
		  c.gridwidth = GridBagConstraints.RELATIVE; 
	   makeButton("Up ", gridbag, c);
		  c.gridwidth = GridBagConstraints.REMAINDER;
	   makeButton("-> ", gridbag, c);
	   ...
	   makeLabel("Next:", gridbag, c, Color.blue, SwingConstants.CENTER);
	 ...
	 public void actionPerformed(ActionEvent ev) {
	   ...
	   if (obj.equals("'x'"))
		  ...
		  { piace.matrix.identity(); piace.matrix.rotate(piace.rotate,"X", false);for (int i=0; i<piace.points3D.size(); i++) piace.matrix.transform((Point3D)piace.points3D.get(i));}
	   else if (obj.equals("'Y'"))  
		  { piace.matrix.identity(); piace.matrix.rotate(piace.rotate,"Y", false);for (int i=0; i<piace.points3D.size(); i++) piace.matrix.transform((Point3D)piace.points3D.get(i));}
	   else if (obj.equals("'Z'")) 
		  { piace.matrix.identity(); piace.matrix.rotate(piace.rotate,"Z", false);for (int i=0; i<piace.points3D.size(); i++) piace.matrix.transform((Point3D)piace.points3D.get(i));}
	 ...
	 protected void makeLabel(String name, GridBagLayout gridbag, GridBagConstraints c, Color color, int position)
	 {
