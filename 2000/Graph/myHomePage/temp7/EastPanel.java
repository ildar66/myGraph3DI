 ...
 import java.awt.event.*;
  ...
  import javax.swing.*; //////////////////////////////////////////////////////////Западная панель
 class EastPanel extends JPanel implements ActionListener{
	 Piace piace;
	 ...
	 public EastPanel(Piace piace) 
	 {
	   ...
	   makeLabel("Face:", gridbag, c, Color.blue, SwingConstants.CENTER);
	   c.gridwidth = 1;
	   ...
	   makeLabel("Scale:", gridbag, c, Color.blue, SwingConstants.CENTER);
	   makeLabel("Select", gridbag, c, Color.yellow, SwingConstants.LEFT);
	   c.gridwidth = 1;
	   ...
	   makeLabel("Figure", gridbag, c, Color.yellow, SwingConstants.LEFT);
	   c.gridwidth = 1;
	   ...
	   makeLabel("Figure All", gridbag, c, Color.yellow, SwingConstants.LEFT);
	   makeButton("PageUp", gridbag, c);
	   makeButton("PageDown", gridbag, c);
 
	   makeLabel("Delete:", gridbag, c, Color.blue, SwingConstants.CENTER);
	   makeLabel("Last Point", gridbag, c, Color.yellow, SwingConstants.LEFT);
	   ...
	   makeLabel("Copy:", gridbag, c, Color.blue, SwingConstants.CENTER);
	   c.gridwidth = GridBagConstraints.RELATIVE;  
	   makeLabel("Select", gridbag, c, Color.yellow, SwingConstants.LEFT);
	   c.gridwidth = GridBagConstraints.REMAINDER; 
